...
const Header = () => {
  return (
    <div className="bg-navy-blue w-full grid grid-cols-12 text-white py-3 px-5 font-medium gap-4 text-xs">
     <div className="flex items-center justify-center gap-4 col-span-2 ">
      <img className="w-27 border border-transparent hover:border-white hover:cursor-pointer p-2" alt="Amazon logo" src="https://www.pngplay.com/wp-content/uploads/3/White-Amazon-Logo-PNG-HD-Quality.png"/>
     ...
     <form className="col-span-7 flex">
      ...
      <input className="flex-1 bg-white text-gray-950 p-2.5 text-[14px]" placeholder="Search Amazon"></input>
     ...
     <div className="col-span-3 flex justify-between items-center">
      <h1 className="text-[14px] border border-transparent hover:border-white hover:cursor-pointer p-2">EN <i className="fa-solid fa-caret-down text-xs"></i></h1>
      <p className="text-center border border-transparent hover:border-white hover:cursor-pointer p-2">Hello, sign in 
        <span className="block text-[14px]">Accounts & Lists <i className="fa-solid fa-caret-down text-xs"></i></span>
      </p>
      <p className="text-center border border-transparent hover:border-white hover:cursor-pointer p-2">Returns 
        <span className="block text-[14px]">& Orders</span>
      </p>
